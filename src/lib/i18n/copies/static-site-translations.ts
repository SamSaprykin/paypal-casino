  ...
  "sv-SE": {
    ...
    sitemap: {
      ...
      labels: {
        ...
        ratingGuidelines: "Guide till casinobetyg",
  ...
  "da-DK": {
    ...
    sitemap: {
      ...
      labels: {
        ...
        terms: "Vilkår",
        ratingGuidelines: "Guide til casino-bedømmelser",
  ...
  "fi-FI": {
    ...
    sitemap: {
      ...
      labels: {
        ...
        terms: "Käyttöehdot",
        ratingGuidelines: "Kasinoluokituksen opas",
  ...
  "de-DE": {
    ...
    sitemap: {
      ...
      labels: {
        ...
        ratingGuidelines: "Leitfaden zur Casino-Bewertung",
  ...
  "nb-NO": {
    ...
    sitemap: {
      ...
      labels: {
        ...
        privacy: "Personvern",
        terms: "Vilkår",
        ratingGuidelines: "Guide til casinovurdering",
