...
export const CASINO_LISTING_CARD_COPY: Record<LocaleId, CasinoListingCardCopy> = {
  ...
  "da-DK": {
    ...
    positiveReviewsTemplate: "{{pct}}% positive anmeldelser fra vores brugere",
  },
  "fi-FI": {
    ...
    positiveReviewsTemplate: "{{pct}}% positiivisia arvosteluja käyttäjiltämme",
  },
  "de-DE": {
    ...
    positiveReviewsTemplate: "{{pct}}% positive Bewertungen von unseren Nutzern",
  },
  "nb-NO": {
    welcomeBonusFallback: "Velkomstbonus",
