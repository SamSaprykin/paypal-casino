...
sections:
  - kind: contentComponent
    ...
    name: Paypal Intro
    bodyMarkdown: |-
      <!-- FLAG (editor): The casino list in this article (Yukon Gold, BitStarz, Stake, Kukimuki) does not match
           PAYPAL_PAYMENTS_COPY.de-DE in the codebase, which currently lists only PlayOJO for Germany.
           These need to be reconciled to one authoritative list before publishing both pieces of content
           on the same site — please confirm which set is correct and actually verified. -->
  ...
  - kind: contentComponent
    ...
    bodyMarkdown: |-
      ...
      <!-- FLAG (editor): The specific figures above (1€/spin limit, 1.000€/month deposit limit) reflect the
           general shape of GlüStV 2021 rules as commonly reported, but limits and enforcement details have
           been revised since the treaty took effect and should be re-verified against the current GGL
           guidance before publishing, rather than treated as fixed. -->
      ...
      **Der Haken:** Mindesteinzahlung für den Bonus lag bei 20 €, nicht wie oft beworben bei 10 €.
      ...
      | Methode | Einzahlung | Auszahlung | Min./Max. pro Transaktion | Verfügbarkeit auf deutschen Casino-Seiten | Beste für |
      |---|---|---|---|---|---|
      | **PayPal** | Sofort | 8–19 Stunden | Meist 10–10.000 € je nach Betreiber | Selten bei GGL-Lizenz; häufiger bei MGA/Curaçao | Käuferschutz & Sicherheit |
      | **Trustly** | Sofort | < 5 Stunden | Bankabhängig | Sehr häufig | Geschwindigkeit |
      | **Kreditkarte** | Sofort | 2–5 Banktage | Casino-spezifisch | Fast überall | Einfachheit |
      | **Sofortüberweisung / Klarna** | Sofort | 1–3 Banktage | Bankabhängig | Häufig bei GGL-Seiten | Direkte Bankanbindung ohne Kartenlimits |
      | **Skrill / Neteller** | Sofort | Meist unter 24 Stunden | Casino-spezifisch | Verbreitet bei MGA-Betreibern | Spieler mit bestehendem E-Wallet |
      | **Apple Pay** | Sofort | Nicht direkt möglich | Gerätegebunden | Wachsend | Mobile Nutzung |
      ...
      **Fazit:** Wenn Sie unbedingt auf einer GGL-lizenzierten deutschen Seite spielen wollen, vergessen Sie PayPal und nutzen Sie Trustly oder Kreditkarte. Wenn Sie PayPals Käuferschutz nutzen möchten, spielen Sie auf einer internationalen MGA-Seite – wissen Sie aber, dass der deutsche Spielerschutz dort nicht greift.
      ...
      ## PayPal-Gebühren im Detail

      Die meisten hier getesteten Casinos erheben selbst keine PayPal-Gebühr. Kosten entstehen typischerweise an anderer Stelle:

      - **Währungsumrechnung:** Läuft Ihr PayPal-Konto auf EUR, aber das Casino intern auf einer anderen Währung, kann eine Umrechnungsgebühr von rund 2,5–4 % anfallen.
      - **Erste Auszahlung:** Praktisch immer langsamer wegen KYC-Prüfung (Ausweis- und Adressverifizierung), unabhängig vom Casino.
      - **Fiat- vs. Krypto-Bonus:** Bei Casinos, die sowohl Krypto als auch PayPal anbieten, ist der Bonus für Fiat-Einzahlungen (PayPal, Kreditkarte) häufig niedriger als für Krypto — wie bei BitStarz im Test.

      ## Deutsche Spielerschutz-Infrastruktur und PayPal-Casinos

      Die zentrale Sperrdatei OASIS gilt für Anbieter mit deutscher GGL-Lizenz. Da die hier getesteten PayPal-Casinos keine GGL-Lizenz haben, greift eine OASIS-Sperre dort **nicht automatisch**. Wer sich selbst vom Glücksspiel ausschließen möchte, sollte das zusätzlich direkt beim jeweiligen internationalen Anbieter sowie ggf. über Software zur Geräte- oder Browsersperrung tun.
  ...
  - kind: faqComponent
    ...
    items:
      ...
      - question: Schützt mich die deutsche Sperrdatei OASIS auch bei PayPal-Casinos ohne GGL-Lizenz?
        answer: Nein, nicht automatisch. OASIS gilt für Anbieter mit deutscher GGL-Lizenz. Die meisten PayPal-Casinos operieren mit MGA- oder Curaçao-Lizenz und sind nicht an OASIS angeschlossen. Wer sich sperren möchte, muss dies zusätzlich direkt beim jeweiligen Anbieter veranlassen.
      - question: Warum bieten so wenige GGL-lizenzierte Casinos PayPal an?
        answer: PayPal stellt eigene Compliance-Anforderungen an Glücksspielanbieter, die mit den strengen deutschen Vorgaben (u.a. Einsatz- und Einzahlungslimits) in der Praxis selten kombiniert werden. Die meisten deutschen GGL-Anbieter setzen daher auf Trustly, Kreditkarte oder Banküberweisung statt PayPal.
---