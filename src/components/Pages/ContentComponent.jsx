...
const IconSwitch = ({ iconName }) => {
 const iconProps =
 "w-9 h-9 text-blue-600 flex-shrink-0";
 const icons = {
 ...
 <span className="inline-block w-9 h-9 bg-gray-200 rounded-full text-blue-600 flex items-center justify-center" > {iconName}</span>
 );
};
...
const tipBoxTextClass =
 "text-yellow-900 leading-relaxed text-sm sm:text-base";
...
const HighlightBox = ({ firstBonus, children }) => {
 ...
 <div className="text-neutral-900 flex-1 text-lg">
 {children}
 </div>
