...
export function ArticleMarkdownProsCons({ prosTitle = "Fordele", consTitle = "Ulemper", pros, cons }) {
 ...
 {pros.map((line, i) => (
 <div key={i} className="pro-item flex gap-2 text-sm leading-relaxed text-neutral-800">
 ...
 <div className="space-y-3">
 {cons.map((line, i) => (
 <div key={i} className="con-item flex gap-2 text-sm leading-relaxed text-neutral-700">
